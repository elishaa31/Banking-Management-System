[6:45 PM, 5/24/2022] Rohit: import tkinter as tk
...
def logged_in_menu(accnt,name):
	...
	rootwn.configure(background='yellow')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
